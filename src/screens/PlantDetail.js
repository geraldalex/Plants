...
<View style={{flex:1}}>
  ...
  function renderRequirements () {
      return(
          <View style={{
              flex:2.5, marginTop:SIZES.padding, marginHorizontal: SIZES.padding, justifyContent:'space-around'
          }}>
<RequirementDetail
icon={icons.sun}
label="SunLight"
...
<View style={{flex:1, flexDirection:'row', alignItems:'center', justifyContent:'center', paddingHorizontal:SIZES.padding, paddingHorizontal:SIZES.padding}}>
